    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: 'user',
            content: `Generate a comprehensive blog post for an AI marketing agency (Imba Marketing) about: ${aiPrompt}. Return ONLY valid JSON (no markdown code blocks) with: title, slug, excerpt (2 sentences), body (markdown, 800+ words), category (one of: AI Marketing, Growth Systems, Performance Advertising, Content Strategy, Marketing Analytics, Conversion Optimisation, Industry Insights), tags (array of strings), read_time_minutes, seo_title, seo_description`,
          }],
        }),
      })
      if (!res.ok) {
